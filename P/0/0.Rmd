...
knitr::opts_chunk$set(echo = FALSE, eval = TRUE, fig.width = 4.5, fig.height = 3.5, fig.show = 'hold', message = FALSE, fig.retina = 3)
...
--
- **Theoretical sessions**: 12 sessions, Friday: 16 - 18h (A5202)
...
- **Home assignments:**
  ...
  Work in groups to analyze real data, create visualizations, interactive reports and apps... 
...
Make groups of 3-4 students to work on the home assignments projects.
...
.pull-left[<center>
<img src="img/descarga.png" width=500/>
</center>
]

.pull-right[
1. Go to https://wooclap.com

2. Introduce the event code: **BJMEAL**

3. Login (SSO) with ATENeA
]
