...
ggplot(data, aes(x=gene_type, 
                 y=log10(median_expression))) +
  geom_boxplot() +
# scale_y_log10() + # another possibility for the log
...
.pull-right[
```{r , warning=F, echo = F, fig.align='center', fig.width=10, fig.height=8}
...
Answer:
&emsp;
Protein-coding genes are the most expressed.
</div>
...
&emsp;<i class="fas fa-comment-dots"></i>
Answer:
The tissue with more expresed genes is testis.
&emsp;
</div>
...
&emsp;<i class="fas fa-comment-dots"></i>
Answer:
In all tissues is highly expressed.
&emsp;
</div>
...
ggplot(data_brain, 
       aes(x=gene_chr, 
           y=median_expression, 
           colour=median_expression > 20000)) +
  geom_point() +
  scale_color_manual(
    values=c("orange2", 
             "cadetblue3"))
