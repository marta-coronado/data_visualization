...
ggplot(data, aes(gene_type, median_expression)) +
  geom_boxplot() +
  scale_y_log10() +
...
ggplot(data[data$expressed,], aes(tissue)) +
  geom_bar()
...
ggplot(data,aes(tissue, median_expression)) +
  geom_boxplot() +
  scale_y_log10() +
  geom_point(data= data_gene, colour= "red")
