...
knitr::opts_chunk$set(echo = FALSE, eval = TRUE, fig.width = 4.5, fig.height = 3.5, fig.show = 'hold', message = FALSE, warning = F,  fig.retina = 3)
# Package for slides
...
- Approximately 8% of XY people are color-blind
